...
Cvar rs_plasma_knockback( "rs_plasma_maxKnockback", "24", CVAR_ARCHIVE );
Cvar rs_plasma_splash( "rs_plasma_splash", "40", CVAR_ARCHIVE );
Cvar rs_rocket_speed( "rs_rocket_speed", "950", CVAR_ARCHIVE );
Cvar rs_rocket_knockback( "rs_rocket_maxKnockback", "108", CVAR_ARCHIVE );
Cvar rs_rocket_splash( "rs_rocket_splash", "120", CVAR_ARCHIVE );
Cvar rs_grenade_speed( "rs_grenade_speed", "800", CVAR_ARCHIVE );
Cvar rs_grenade_knockback( "rs_grenade_maxKnockback", "120", CVAR_ARCHIVE );
